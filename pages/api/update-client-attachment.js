...
function parseBody(body, existing) {
  return {
    ...
    linked_proposal_id: body.linked_proposal_id !== undefined ? body.linked_proposal_id || null : (existing?.linked_proposal_id ?? null),
    linked_invoice_id: body.linked_invoice_id !== undefined ? body.linked_invoice_id || null : (existing?.linked_invoice_id ?? null),
    linked_email_id: body.linked_email_id !== undefined ? body.linked_email_id || null : (existing?.linked_email_id ?? null),
