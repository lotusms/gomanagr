export default function ContractsPageSkeleton() {
  return (
    <div className="space-y-6" data-testid="contracts-page-skeleton">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800 flex flex-col">
            <div className="bg-gray-300 dark:bg-gray-600 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div className="h-6 flex-1 rounded bg-gray-400 dark:bg-gray-500 animate-pulse" />
              </div>
            </div>
