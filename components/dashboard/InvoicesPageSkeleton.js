 ...
 * Matches the layout: PageHeader, grid of services-style invoice cards (sm:grid-cols-2 lg:grid-cols-3).
 */
export default function InvoicesPageSkeleton() {
  return (
    <div className="space-y-6" data-testid="invoices-page-skeleton">
      {/* Header: title, description, Create invoice button */}
      ...
      {/* Grid of services-style invoice card placeholders */}
