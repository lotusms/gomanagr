...
const PROVIDER_META = Object.freeze({
  ...
  smtp: {
    name: 'SMTP',
    description: 'Send transactional email (invoices, receipts, proposals, invites) via your own SMTP server.',
    icon: 'mail',
    fields: [
      { key: 'host', label: 'SMTP host', placeholder: 'smtp.example.com', mask: false },
      { key: 'port', label: 'SMTP port', placeholder: '587', mask: false },
      { key: 'secure', label: 'Use TLS (port 465)', type: 'boolean', optional: true },
      { key: 'user', label: 'SMTP user', placeholder: 'noreply@yourdomain.com', mask: false },
      { key: 'password', label: 'SMTP password', placeholder: '...', mask: true, secret: true },
      { key: 'fromEmail', label: 'From email', placeholder: 'noreply@yourdomain.com', mask: false },
      { key: 'fromName', label: 'From name', placeholder: 'Your Company', mask: false, optional: true },
    ],
  },
  resend: {
    name: 'Resend',
