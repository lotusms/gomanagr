...
export default function ProviderStatusBadge({ status }) {
  ...
  const styles = {
    ...
    not_connected: 'bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300',
    misconfigured: 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300',
  };
  const labels = {
    connected: 'Connected',
