...
export default function EditClientMeetingNotePage() {
  ...
  if (loading) {
    return (
      <>
        <Head>
          <title>Edit meeting note - GoManagr</title>
        </Head>
  ...
  if (notFound || !note) {
    return (
      <>
        <Head>
          <title>Meeting note not found - GoManagr</title>
        </Head>
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-400">Meeting note not found.</p>
          <Link href={backUrl}>
  ...
  return (
    <>
      <Head>
        <title>Edit meeting note - GoManagr</title>
        <meta name="description" content="Edit this meeting note" />
      </Head>
      <div className="space-y-6">
        <PageHeader
          title="Edit meeting note"
          description="Update the details of this meeting note."
          actions={
            <Link href={backUrl}>
              <SecondaryButton type="button" className="gap-2">
                <HiArrowLeft className="w-5 h-5" />
